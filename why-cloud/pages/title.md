...
Wednesday 22 July 2026 &middot; 10:30 am MYT
</div>

<div v-motion :initial="{ opacity: 0 }" :enter="{ opacity: 1, transition: { delay: 700, duration: 500 } }" class="mt-9 text-xl">
<span class="text-orange-600 dark:text-orange-400 font-600">no hardware</span>
<span class="opacity-40 mx-2">&middot;</span>
<span class="text-orange-600 dark:text-orange-400 font-600">scales instantly</span>
<span class="opacity-40 mx-2">&middot;</span>
<span class="text-orange-600 dark:text-orange-400 font-600">goes global</span>
</div>
...
Today stands alone: anyone who missed Monday or Tuesday can follow everything. If you were here yesterday, you saw a web page go live on GitHub Pages; today we go one level deeper and rent a real computer on the internet.
Set the promise plainly: by the end of the session there will be a real server running on AWS, and it will answer visitors from every continent through Cloudflare.
-->
