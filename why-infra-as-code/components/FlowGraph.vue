...
const props = withDefaults(defineProps<{ nodes?: Node[]; edges?: Edge[]; groups?: Group[]; width?: number; height?: number }>(), {
  ...
  nodes: () => [
    ...
    { shape: 'diamond', cx: 300, cy: 105, w: 132, h: 96, icon: 'help-circle-outline', color: 'amber', label: ['Image lokal', 'ada?'], at: 1 },
    { shape: 'rect', cx: 480, cy: 50, w: 132, h: 46, icon: 'download', color: 'blue', label: 'docker pull', at: 2 },
    { shape: 'rect', cx: 600, cy: 120, w: 150, h: 46, icon: 'cube-outline', color: 'green', label: 'Cipta container', at: 3 },
    { shape: 'rect', cx: 748, cy: 120, w: 110, h: 46, icon: 'play', color: 'green', label: 'Jalankan', at: 4 },
  ],
  edges: () => [
    { at: 1, d: 'M171 105 H229', ax: 229, ay: 105, adeg: 0 },
    { at: 2, d: 'M300 60 C 345 52, 385 50, 412 50', ax: 412, ay: 50, adeg: 0, lx: 352, ly: 40, lw: 44, label: 'Tidak', lc: 'amber' },
    { at: 3, d: 'M480 73 C 512 100, 518 108, 536 112', ax: 536, ay: 112, adeg: 30 },
    { at: 3, d: 'M366 105 C 440 105, 470 116, 523 118', ax: 523, ay: 118, adeg: 14, lx: 452, ly: 112, lw: 34, label: 'Ya', lc: 'green' },
