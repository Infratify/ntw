...
[click] the edit: count is how many copies of the server block should exist. One becomes three; save; that is the entire change.
[click] apply works out the difference by itself: two to add, because one already runs. Two new servers appear, the console shows three machines, and the same stall page answers at three addresses.
...
3. terraform apply, yes. Console: three instances running. Open one new IP: the same stall page.
