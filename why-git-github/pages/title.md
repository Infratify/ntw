...
Tuesday 21 July 2026 &middot; 10:30 am MYT
</div>

<div v-motion :initial="{ opacity: 0 }" :enter="{ opacity: 1, transition: { delay: 700, duration: 500 } }" class="mt-9 text-xl">
<span class="text-red-600 dark:text-red-400 font-600">never forget</span>
<span class="opacity-40 mx-2">&middot;</span>
<span class="text-red-600 dark:text-red-400 font-600">team ready</span>
<span class="opacity-40 mx-2">&middot;</span>
<span class="text-red-600 dark:text-red-400 font-600">career proof</span>
</div>
